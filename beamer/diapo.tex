% /solutions/confer<F3>ence-talks/conference-ornate-20min.fr.tex, 22/02/2006 De Sousa
...
\date[ ~ ~ ~ 30 / 04 / 2015] % (facultatif, peut être une abr\'eviation du nom de la conf\'erence)
{Jeudi 30 Avril 2015}
...
\FlorentSpeak{}
	...
	\begin{frame}{Les box et périphériques}
		...
		\end{itemize}
						\begin{figure}[H]
							...
							\caption{Exemple de périphériques
							spécifiques\newline
	...
	\begin{frame}{Le Cloud computing}
		...
		\begin{exampleblock}{Avantages}
			\begin{itemize}
				\item IHM identique sur chaque périphérique connecté
				\item Passage d'un écran à un autre sans << perte d'informations >>
				\item Poursuivre le visionnage hors de chez soi en se connectant au \textit{cloud}
			\end{itemize}
		\end{exampleblock}
				\vfill
